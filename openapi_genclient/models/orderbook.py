...
class Orderbook(object):
    ...
    def __init__(self, figi=None, depth=None, bids=None, asks=None, trade_status=None, min_price_increment=None, last_price=None, close_price=None, limit_up=None, limit_down=None):  # noqa: E501
